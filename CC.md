Prešiel som dokument riadok po riadku. Zapracoval som štyri pripomienky, šesť odpovedí na otázky a päť textových úprav, ktoré biznis urobil priamo v texte.
...
1. **Kontrola A1 sa nevykonáva voči ODS.** V dátach z ODS sú iba údaje dodávateľa. IČ DPH odberateľa na faktúre je IČ DPH Tatra banky a systém ho porovnáva s pevnou hodnotou SK7020000944, nie s ODS. Opravené v hlavnom toku aj v tabuľke kontrol. Doplnená otázka, ktorý atribút XML túto hodnotu nesie.
2. **Akcie na zmenu stavu sú dostupné aj na obrazovke detailu.** Ak faktúra nevyžaduje úpravy, spracovateľ ju vie odoslať, odložiť alebo stornovať priamo z detailu. Doplnený alternatívny tok.
3. **Obraz faktúry je možné uložiť ako súbor** v statusoch 2 a 3 pre priloženie k požiadavke na založenie kmeňových dát.
4. **Dodávateľské faktúry prídu do eInvoice len v XML.** Z API sekcie odstránená veta o tom, že nie všetky faktúry majú XML - tá sa týka odchádzajúcich faktúr, ktoré do tohto UC nepatria.

**Zapracované odpovede na otázky**

5. Po manuálnej zmene dodávateľa sa spúšťa **kontrola B aj kontrola C**.
6. Výzva na uloženie zmien sa zobrazí **iba vtedy, keď spracovateľ reálne niečo zmenil**.
7. Po odoslaní faktúra vypadne zo záložky Na spracovanie a **spracovateľ sa vráti do zoznamu faktúr v danej záložke**.
8. Návrat na zoznam platí **aj po odložení a stornovaní** faktúry.
9. Akcie na zmenu stavu **môžu byť aj na obrazovke detailu**.
10. Uloženie obrazu faktúry je **manuálne stiahnutie súboru spracovateľom** na úložisko a následné priloženie k požiadavke. Automatické priloženie priamo do iProc je vedené ako rozvoj do budúcna.

**Zapracované textové úpravy biznisu**

11. Spúšťač spresnený - spracovateľ klikne na detail pri vybranej faktúre.
12. V AT 1b doplnené, že spracovateľ informuje dodávateľa, že faktúru neakceptujeme, a s uvedením dôvodu ho požiada o opravu alebo o vystavenie dobropisu.
13. Odkazy opravené podľa aktuálneho stromu v Confluence - história zmien je **UC-203** (nie UC-902), zoznam faktúr je **UC-201** (nie UC-06).

**Nezapracované, vyžaduje rozhodnutie**

14. V biznis zadaní bola požiadavka na založenie kmeňových dát zmenená z iProc na **UPI**, na ostatných šiestich miestach v dokumente však zostal iProc. Ponechal som iProc a doplnil otázku, keďže nevidím podklad, ktorý by zmenu potvrdzoval.
...
| 11 | Spôsob a frekvencia načítania exportu dodávateľov z ODS. | Architekt, vývoj |
| 12 | Akým spôsobom sa vygeneruje súbor s obrazom faktúry, ktorý si spracovateľ stiahne? | Architekt |
| 13 | Prílohy na detaile (dostupnosť na stiahnutie). | Biznis |
| 14 | Jazyk názvov polí (EN vs SK). | Biznis, UX |
| 15 | Role a oprávnenia (kto smie editovať, holdovať, rušiť, púšťať do iProc). | Biznis |
| 16 | **Nová:** Ktorý atribút XML nesie IČ DPH odberateľa, ktoré sa v kontrole A1 porovnáva s hodnotou SK7020000944? | Architekt |
| 17 | **Nová:** Zadáva sa požiadavka na založenie dodávateľa a čísla účtu do iProc, alebo do UPI? V biznis zadaní bolo uvedené UPI, v alternatívnych tokoch iProc. | Biznis |
| 18 | Podľa akých údajov spracovateľ vyhľadáva správneho dodávateľa pri oprave nesprávnej identifikácie - IČO, DIČ, názov, alebo kombinácia? | Biznis |
| 19 | Je oprava dodávateľa dostupná vo všetkých statusoch, kde je faktúra editovateľná, alebo len vo vybraných? | Biznis |
| 20 | Má systém pri malom nesúlade sám ponúknuť zoznam kandidátov na dodávateľa, ako to robí ABBYY, alebo dodávateľa vyhľadáva spracovateľ? | Biznis |
| 21 | Je akcia na uloženie obrazu faktúry dostupná len v statusoch 2 a 3, alebo vo všetkých statusoch? | Biznis |
| 22 | Ak sa PDF negeneruje, aký iný čitateľný formát je pre iProc akceptovateľný? | Biznis, architekt |
| 23 | Smeruje preklik z iProc na obraz faktúry priamo do eInvoice, alebo cez DMS? Ak cez DMS, čo sa tam ukladá a kto to tam ukladá? Ak priamo do eInvoice, ako sa zachová kompatibilita s existujúcimi linkami do DMS? | Architekt |
...
(OTVORENY BOD: ktorý atribút XML nesie IČ DPH odberateľa - viď otázka 16)
...
Rozpor iProc verzus UPI je jediná pripomienka, ktorú som nezapracoval. V biznis zadaní bolo prepísané na UPI, ale na šiestich ďalších miestach zostal iProc, a 10b hovorí o requeste do iProc. Nechal som iProc a doplnil otázku 17 - je to jednovetová odpoveď, ale mení sa ňou popis toku na dvoch miestach.

Pripomienka k IČ DPH odberateľa odhalila chybu, ktorá tam bola odo mňa. V hlavnom toku som mal IČ DPH odberateľa v zozname polí, pri ktorých sa zobrazuje hodnota z ODS. To bolo nesprávne - ODS obsahuje iba údaje dodávateľa. Opravené na troch miestach.

Odpoveď na akcie na detaile prináša jednu vec, ktorú treba doriešiť neskôr: ak je faktúra v statuse 2 alebo 3, kde nie sú manuálne meniteľné stavy, ale spracovateľ ju chce stornovať priamo z detailu, musí to byť povolené. V stavovom modeli to je pre status 2 vyriešené (povolený prechod na 7), ale pre status 3 nie. Odporúčam to skontrolovať pri najbližšej revízii stavového modelu.